...
public class DireccionClienteDAO {
    private static final String SQL_SELECT ="SELECT * FROM direccioncliente";    
    private static final String SQL_INSERT ="INSERT INTO direccioncliente (ciudad,calle,comuna,numero) VALUES (?,?,?,?)";
    ...
    private static final String SQL_CHECK_EXISTENCE = "SELECT COUNT(*) FROM direccioncliente WHERE idDireccion = ?";
