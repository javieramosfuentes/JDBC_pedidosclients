...
public class JDBC_pedidosclients {
                ...
                case "Clientes":
                    ...
                    switch (accion) {
                        ...
                        case "3":
                            ...
                            String id = sc.nextLine();
                            muestraClientes(clienteDAO);
                            //Confirmación de boorrado
                            System.out.print("");
                            if(clienteDAO.comprobarExistencia(Integer.parseInt(id))){
                                Cliente cl = clienteDAO.obtener(Integer.parseInt(id));
                                clienteDAO.eliminarPedidos(Integer.parseInt(id));
                                
                                clienteDAO.eliminar(Integer.parseInt(id));
                            }
                            else
                                System.out.println("No se ha encontrado el cliente con ID: ("+ id +")");
                            break;
                        case "4":
                            muestraClientes(clienteDAO);
                            System.out.println("");
                ...
                case "Pedidos":
                    ...
                    switch (accion) {
                        ...
                        case "2":
                            ...
                            for(boolean masArticulos = true;masArticulos;){
                                ...
                                if("si".equals(opcion)){
                                    ...
                                    if(artDAO.comprobarExistencia(Integer.parseInt(articulo))){
                                        ...
                                        System.out.println("No se ha encontrado el artículo con ID: ("+ articulo +")");
                                    }
                                }else{
                                    break;
                                }
                        ...
                        case "3":
                            ...
                            String id = sc.nextLine();
                            System.out.println("");
                            if(pedidoDAO.comprobarExistencia(Integer.parseInt(id)))
                        ...
                        case "4":
                            ...
                            if(pedidoDAO.comprobarExistencia(Integer.parseInt(id_pedido))){
                                System.out.println("");
                                ...
                                if(cliDAO.comprobarExistencia(Integer.parseInt(idCliente))){
                                    ...
                                    if("si".equals(dirOpc)){
                                        ...
                                        switch(seleccionEnvio){
                                            case "s":
                                                ...
                                                System.out.print("->");
                                                String direccion = sc.nextLine();
                                                if(dirCliDAO.comprobarExistencia(Integer.parseInt(direccion))){
                                    ...
                                    for(boolean masArticulos = true;masArticulos;){
                                        ...
                                        if("no".equals(opcion)){
                                            ...
                                            if(artDAO.comprobarExistencia(Integer.parseInt(articulo))){
                                                System.out.print("Cantidad:");
                                                String cantidad = sc.nextLine();
                                                PedidoArticulo pedidoArt = new PedidoArticulo(Integer.parseInt(cantidad),pedidoDAO.obtener(updatePedido).getId_pedido(),Integer.parseInt(articulo));
                                                PedidoArticuloDAO pedDAO = new PedidoArticuloDAO();
                                                pedDAO.insertar(pedidoArt);
                                                System.out.println("");
                                ...
                                System.out.println("No se ha encontrado el pedido con ID: ("+ id_pedido +")");
                            break;
                    }
                    break;
                case "Articulos":
                    ...
                    switch (accion) {
                        ...
                        case "3":
                            ...
                            System.out.print("-> ");
                            String id = sc.nextLine();
                            if(articuloDAO.comprobarExistencia(Integer.parseInt(id)))
                                articuloDAO.eliminar(Integer.parseInt(id));
                            else
                                System.out.println("No se ha encontrado el artículo con ID: ("+ id +")");
                        break;
                        case "4":
                            muestraArticulos(articuloDAO);
                            System.out.println("");
                            ...
                            if(articuloDAO.comprobarExistencia(Integer.parseInt(id))){
                                ...
                                System.out.print("Id de la fábrica:");
                                fabrica = sc.nextLine();
                                if(fabricaDAO.comprobarExistencia(Integer.parseInt(fabrica))){
                                    ...
                                    System.out.println("No se ha encontrado la fabrica con ID: ("+ fabrica +")");
                            }
                            else
                                System.out.println("No se ha encontrado el artículo con ID: ("+ id +")");
                        break;
                ...
                case "Fabricas":
                    ...
                    switch (accion) {
                        ...
                        case "3":
                            ...
                            System.out.print("-> ");
                            String id = sc.nextLine();
                            if(fabricaDAO.comprobarExistencia(Integer.parseInt(id))){
                                System.out.println("");
                                fabricaDAO.eliminar(Integer.parseInt(id));
                                System.out.println("-- Fabrica eliminada correctamente --");
                            }else
                                System.out.println("No se ha encontrado la fabrica con ID: ("+ id +")");
                        break;
                        case "4":
                            muestraFabricas(fabricaDAO);
                            System.out.println("");
                ...
                case "Direcciones":
                    ...
                    switch (accion) {
                        ...
                        case "3":
                            ...
                            System.out.print("-> ");
                            String id = sc.nextLine();
                            if(direccionEnvioCliDAO.comprobarExistencia(Integer.parseInt(id))){
    ...
    public static void muestraClientes(ClienteDAO clienteDAO)throws SQLException{
        ...
        if(clientes.isEmpty()){
            System.out.println("No se han encontrado clientes, quiere crear uno? (si/no):");
            System.out.print("-> ");
            String addCliente = sc.nextLine();
            if(addCliente.equals("si"))
                seleccionTabla("2");
        }else{
    ...
    public static void muestraArticulos(ArticuloDAO articuloDAO)throws SQLException{
        ...
        if(articulos.isEmpty()){
            System.out.println("No se han encontrado artículos, quiere crear uno? (si/no):");
            System.out.print("-> ");
            String addCliente = sc.nextLine();
            if(addCliente.equals("si"))
                seleccionTabla("2");
    ...
    public static void muestraPedidos(PedidoDAO pedidoDAO)throws SQLException{
        ...
        if(pedidos.isEmpty()){
            System.out.println("No se han encontrado pedidos, quiere crear uno? (si/no):");
            System.out.print("-> ");
            String addCliente = sc.nextLine();
            if(addCliente.equals("si"))
                seleccionTabla("2");
    ...
    if(pedidos.isEmpty()){
        ...
        pedidos.forEach(ped -> {
            try {
                ...
                if(pedidos.isEmpty()){
                    System.out.println("No se han encontrado artículos en el pedido ("+ ped.getId_pedido() +"), quiere crear uno? (si/no):");
                    System.out.print("-> ");
                    String addCliente = sc.nextLine();
                    if(addCliente.equals("si"))
                        seleccionTabla("2");
    ...
    public static void muestraFabricas(FabricaDAO fabricaDAO)throws SQLException{
        ...
        if(fabricas.isEmpty()){
            System.out.println("No se han encontrado fabricas, quiere crear una? (si/no):");
            System.out.print("-> ");
            String addCliente = sc.nextLine();
            if(addCliente.equals("si"))
                seleccionTabla("2");
    ...
    public static void muestraDireccionesClientes(DireccionClienteDAO dirCliDAO)throws SQLException{
        ...
        if(direccionesCliente.isEmpty()){
            System.out.println("No se han encontrado direcciones de los clientes, quiere crear una? (si/no):");
            System.out.print("-> ");
            String addCliente = sc.nextLine();
            if(addCliente.equals("si"))
                seleccionTabla("2");
    ...
    public static void muestraDireccionesPedidos(DireccionPedidoDAO direccionesPedDAO)throws SQLException{
        ...
        if(direccionesPed.isEmpty()){
            System.out.println("No se han encontrado direcciones de pedidos, quiere crear una? (si/no):");
            System.out.print("-> ");
            String addCliente = sc.nextLine();
            if(addCliente.equals("si"))
                seleccionTabla("2");
